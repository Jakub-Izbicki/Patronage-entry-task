...
public class MovieControllerTest {
    ...
    public void testGetMovieActors() throws Exception {
        ...
        String uri = "/api/movies/1/actors";
    ...
    public void testAddActorToMovie() throws Exception {
        ...
        String uri = "/api/admin/movies/1/actors/1";
